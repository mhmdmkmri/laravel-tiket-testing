    ...
    <div class="card shadow mb-4 mt-2">
        <form action="{{ route('rute.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="start">Band</label>
                    <input type="text" class="form-control" id="start" name="start" value="{{ $rute->start }}"
                        required />
                </div>
                <div class="form-group">
                    <label for="end">Stage</label>
                    <input type="text" class="form-control" id="end" name="end" value="{{ $rute->end }}"
                        required />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="time" class="form-control" id="jam" name="jam" value="{{ $rute->jam }}"
                        required />
                </div>
                <div class="form-group">
                    <label for="transportasi_id">Event</label><br>
                    <select class="select2 form-control" id="transportasi_id" name="transportasi_id" required
                        ...
                        @foreach ($transportasi as $data)
                            <option value="{{ $data->id }}" @if ($data->id == $rute->transportasi_id) selected @endif>
